...
#define MAILBOX_READ_REG       ((volatile unsigned int*)(MBOX_BASE+0x0))
#define MAILBOX_STATUS_REG     ((volatile unsigned int*)(MBOX_BASE+0x18))
#define MAILBOX_WRITE_REG      ((volatile unsigned int*)(MBOX_BASE+0x20))
